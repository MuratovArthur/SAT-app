...
import 'package:meditation_app/questions/vocab10_brain.dart';

VocabularyBank vocabularyBrain = VocabularyBank();

class VocabularyTenthPage extends StatefulWidget {
  @override
  _VocabularyTenthPageState createState() => _VocabularyTenthPageState();
}

class _VocabularyTenthPageState extends State<VocabularyTenthPage> {
