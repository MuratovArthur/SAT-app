...
class MathBank {
  ...
  List<Question> introQuestionBank = [
    Question(r'If \( m-n \over n\) \(=\) \( 4 \over n\), what is the value of \( n \over m\)',
        'A', null,
        r'\(9 \over 13\)',
        r'\(7 \over 14\)',
        r'\(9 \over 5\)',
    ...
    Question(r'If \( p+4 \over p-4\) \(= 13\), what is the value of \(p\) ?',
     'D', null, 
     r'\(2 \over 3\)',
     r'\(10 \over 13\)',
     r'\(28 \over 9\)',
     r'\(14 \over 3\)',
     r' If \( p+4 \over p-4\) \(= 13\), then \(13(p - 4) = p + 4\) \(p = \) \(56 \over 12\) \(=\) \(14 \over 3\) '),
    Question(r'If \(4x +7 = 12\), what is the value of \(8x+3\) ?',
     'C', null,
      r'9', 
      r'11', 
      r'13',
    ...
    Question(r'\(6 \over x\) \(=\) \(4 \over x-9\), what is the value of \(x \over 18\) ? ',
     'D', null, 
     r'\(3\)',
      r'\(2\)',
       r'\(1\over 2\)',
    ...
    Question(r'If \(3j - (k+5) = 15 - 4k\), what is the value of \(j + k\)?',
     'B', null,
      r'8',
       r'7',
        r'5',
    ...
    Question(r'If \(1 \over 2\)\((10p + 2)\) \(= p +7\), then \(4p\) \(=\)',
     'A', null,
      r'\(6\)',
       r'\(5 \over2\)',
        r'\(4\)',
    ...
    Question(r'If \(0.25y +0.36 = 0.33y -1.48\), what is the value of \(y \over 10\)?',
     'A', null,
      r'2.30',
       r'1.40',
        r'0.75',
    ...
    Question(r'If \(4 \over 7\)\(k\) \(= 36\), then \(3 \over7\)\(k\) \(=\) ',
     'B', null,
      r'21',
       r'27',
        r'32',
    ...
    Question(r'If \(1 \over 2\)\(x\) \(+\) \(1 \over 4\)\(x\) \(+\) \(1 \over 8\)\(x\) \(= 14\), then \(x =\)',
     'D', null,
      r'4',
       r'8',
        r'12',
    ...
    Question(r'If \(2 \over x\)\(= 2\), then \(x + 2\) \(=\)',
     'C', null,
      r'\(3 \over 2\)',
       r'\(5 \over 2 \)',
        r'\(3\)',
    ...
    Question(r'If \(y - 2 \over 2\) \(=\) \(y + 2\), then \(y =\)',
     'A', null,
      r'-6',
       r'-4',
        r'-2',
    ...
    Question(r'If \(2y \over 7\) \(=\) \(y + 3 \over 4\), then \(y =\)',
     'D', null,
      r'5',
       r'9',
        r'13',
    ...
    Question(r'If \(y \over 3\) \(=\), then \(3y =\)',
     'D', null,
      r'4',
       r'12',
        r'24',
    ...
    Question(r'When the number k is multiplied by 5, the result is the same as when 5 is added to k. What is the value of k?',
     'C', null,
      r'\(4 \over 5\)',
       r'\(1\)',
        r'\(5 \over 4\)',
         r'\(3 \over 2\)',
          r'According to the conditions of the problem, 5k = k + 5 so 5k − k = 5. Since 4k = 5, k = \(5 \over 4\) '),
