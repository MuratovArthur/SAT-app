...
class MathBank {
  ...
  List<Question> introQuestionBank = [
    Question(r'|n - 10| < 4 ; How many integers n satisfy the inequality above?',
     'C', null,
      r'Two',
       r'Five',
        r'Seven',
    ...
    Question(r'If |x| ≤ 2 and |y| ≤ 1, then what is the least possible value of x − y?',
     'A', null,
      r'-3',
       r'-2',
        r'-1',
    ...
    Question(r'If |\(1 \over 2\) \(x\)| \(≥\) \(1 \over 2\), then which statement must be true?',
     'B', null,
      r'\(x ≤ -2\) or \(x ≥ 2\)',
       r'\(x ≤ -1\) or \(x ≥ 1\)',
    ...
    Question(r'If \(1 \over 2\)\(|x|\) and \(|y| = x + 1\), they \(y^2\) could be',
     'D', null,
      r'2',
       r'3',
        r'4',
    ...
    Question(r'In a certain greenhouse for plants, the Fahrenheit temperature, F, is controlled so that it does not vary from 79° by more than 7°. Which of the following best expresses the possible range in Fahrenheit temperatures of the greenhouse? ',
     'A', null,
      r'F – 79| ≤ 7',
       r'|F – 79| > 7',
        r'|F – 7| ≤ 79',
    ...
    Question(r'If \(|a + 3| \over 2\)\(= 1\) and \(2|2b + 1| = 6\), then \(|a + b|\) could equal any of the following EXCEPT',
     'D', null,
      r'1',
       r'3',
        r'5',
         r'7',
          r'If \(|a + 3| \over 2\) \(= 1\) then |a + 3| = 2, so a + 3 = 2 or a + 3 = −2. Hence, a = −1 or a = −5. If 2|b + 1| = 6, then |b + 1| = 3, so b + 1 = 3 or b + 1 = −3. Hence, b = 2 or b = −4. Then |a + b| could equal the following: ■ |−1 + 2| = 1 ■ |−1 + (−4)| = 5 ■ |−5 + 2| = 3 ■ |−5 + (−4)| = 9 Thus, |a + b| could not equal 7.'),
    Question(r'For what value of x is |1 + x| = |1 − x|? ',
     'D', null,
      r'No value ',
       r'1',
        r'-1',
    ...
    Question(r' −1 < x < 3. The inequality above is equivalent to which of the following?',
     'A', null,
      r'|x − 1| < 2',
       r'|x + 1| < 2',
        r'|x − 2| < 1',
    ...
    Question(r'A certain medication must be stored at a temperature, t, that may range between a low of 45° Fahrenheit and a high of 85° Fahrenheit. Which inequality represents the allowable range of Fahrenheit temperatures?',
     'A', null,
      r'|t − 65| ≤ 20',
       r'|t + 20| ≤ 65',
        r'|t + 65| ≤ 20',
    ...
    Question(r'The inequality |1.5C − 24| ≤ 30 represents the range of monthly average temperatures, C, in degrees Celsius, during the winter months for a certain city. What was the lowest monthly average temperature, in degrees Celsius, for this city?',
     'A', null,
      r'-4',
       r'0',
        r'6',
