...
class MathBank {
  ...
  List<Question> introQuestionBank = [
    Question(r'If \(V =\) \(1 \over 3\)\(Bh\), what is \(h\) in terms of \(B\) and \(V\)?',
     'C', null,
      r'\(1 \over 3\)\(VB\)',
       r'\(V \over 3B\)',
        r'\(3V \over 3B\)',
    ...
    Question(r'If \(F =\) \(kmM \over r^2\), then \(m =\)',
     'A', null,
      r'\(Fr^2 \over kM\)',
       r'\(kFr^2 \over M\)',
        r'\(kM \over Fr^2\)',
    ...
    Question(r'If \(P =2(L + W)\), what is \(W\) in terms of \(P\) and \(L\) ?',
     'B', null,
      r'\(P -2L\)',
       r'\(P -2L \over 2\)',
        r'\(2L -P \over 2\)',
    ...
    Question(r'If \(A =\) \(1 \over 2\) \(h(x + y)\), what is y in terms of  \(A, h\) and  \(x\)?',
     'A', null,
      r' \(2A -hx \over h\)',
       r' \(A -hx \over 2h\)',
        r' \(2Ah -x\)',
    ...
    Question(r'If  \(s =\) \(2x +t \over r\), then  \(x =\)',
     'A', null,
      r' \(rs -t \over 2\)',
       r' \(rs + 1 \over 2\)',
        r' \(2rs -t\)',
    ...
    Question(r'If  \(x =\) \(x0 +\) \(1 \over 2\)\((v + v0)t\), what is  \(v\) in terms of the other variables?',
     'B', null,
      r' \(2(x- x0) \over v0t\)',
       r' \(2(x -x0) \over t\)  \(-v0\)',
        r' \(t(x -x0) \over 2v0\)',
         r'  \(v0t -\)  \(2(x-x0) \over t\)',
          r'If  \(x =\) \(x0 +\) \(1 \over 2\)\((v + v0)t\) then (v + v0)t = 2(x − x0) so vt + v0t = 2(x − x0) and vt = 2(x − x0) − v0t. Dividing each term of the last equation by t gives \(2(x -x0) \over t\)  \(-v0\)'),
    Question(r'If 2s − 3t = 3t − s, what is s in terms of t?',
     'B', null,
      r'\(t \over 2\)',
       r'\(2t\)',
        r'\(t + 2\)',
    ...
    Question(r'If xy + z = y, what is x in terms of y and z?',
     'C', null,
      r'\(y + z \over y\)',
       r'\(y -z \over z\)',
        r'\( y-z \over y\)',
    ...
    Question(r'If b(x + 2y) = 60 and by = 15, what is the value of bx?',
     'D', null,
      r'15',
       r'20',
        r'25',
    ...
    Question(r'If \(a - b \over b\)\(=\)\(2 \over 3\), what is the value of \(a \over b\)?',
     'D', null,
      r'\(1 \over 2\)',
       r'\(3 \over 5\)',
        r'\(3 \over 2\)',
    ...
    Question(r'If s + 3s is 2 more than t + 3t, then s − t =',
     'C', null,
      r'-2',
       r'\(-1 \over 2\)',
        r'\(1 \over 2\)',
         r'\(3 \over 4\)',
          r'Since it is given that s + 3s is 2 more than t + 3t, s + 3s = (t + 3t) + 2 or, equivalently, 4s = 4t + 2, so 4s − 4t = 2. Dividing each member of the equation by 4 gives \(4s \over s\)\(-\)\(4y \over 4\)\(=\)\(2 \over 4\), which simplifies to \(s - t=\)\(1 \over 2\)'),
    Question(r'If \(1 \over p + q\)\(= r\) and \(p\) not equal to \(-q\), what is \(p\) in terms of \(r\) and \(q\)? ',
     'D', null,
      r'\(rq- 1 \over q\)',
       r'\(1 + rq \over q\)',
        r'\( r \over 1 + rq\)',
    ...
    Question(r'If \(a + b + c \over 3 \) \(=\) \(a + b \over 2\) then \(c =\)',
     'B', null,
      r'\(a - b \over 2\)',
       r'\(a + b \over 2\)',
        r'\( 5a + 5b\)',
    ...
    Question(r'If the value of n nickels plus d dimes is c cents, what is n in terms of d?',
     'A', null,
      r'\(c \over 5\)\(- 2d\)',
       r'\(5c -2d\)',
        r'\(c -d \over 10\)',
    ...
    Question(r'If \(c \over d\)\(-\)\(a \over b\)\(=x\), and \(b=5d\), what is the value of \(c \over d\) in tems of \(x\)?',
     'D', null,
      r'\(c \over 5\)\(- 2d\)',
       r'\(5c -2d\)',
        r'\( c - d \over 10\)',
