...
class MathBank {
  ...
  List<Question> introQuestionBank = [
    ...
    Question(
        r'\(2(x+y)=3y + 5\)  and \(3x +2y = -3;\) Which equivalent equation could be used to solve the system of equations above?',
        'A',
        null,
        r'\(3\)\(({5 + y \over 2})\)\(+ 2y = -3\)',
        r'\(3\)\(({{5 \over 2} - {y}})\)\(+ 2y = -3\)',
    ...
    Question(
        ...
        r'\(5\)',
        r'\(7\)',
        r'In the equation \(a \over b\)\(=\)\(2 \over 5\), cross-multiplying gives \(5a = 2b\). Since \(5a + 3b = 35\) and \(5a = 2b\), then \(2b + 3b =35\); \(b =7\). Since \(5a = 2b = 2(7) = 14; \) \( a =\)\(14 \over 5\)'),
    Question(
        r'If \(x \over y\)\(= 6\), \(y \over w\)\(= 4\), and \(x=36\) what is the value of \(w\)?',
        'B',
        null,
        r'\(1 \over 2\)',
        r'\(3 \over 2\)',
