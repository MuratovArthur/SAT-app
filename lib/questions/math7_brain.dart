...
class MathBank {
  ...
  List<Question> introQuestionBank = [
    Question(r'If 2x − 3y = 11 and 3x + 15 = 0, what is the value of y?',
     'A', null,
      r'-7',
       r'-5',
        r'\(1 \over 3\)',
    ...
    Question(r'If 2a = 3b and 4a + b = 21, then b = ',
     'B', null,
      r'1',
       r'3',
        r'4',
    ...
    Question(r'If 2p + q = 11 and p + 2q = 13, then p + q = ',
     'B', null,
      r'6',
       r'8',
        r'9',
    ...
    Question(r'\(2(x+y)=3y + 5\); \(3x +2y = -3\); Which equivalent equation could be used to solve the system of equations above?',
     'A', null,
      r'\(3\)\((5 + y \over 2)\)\(+ 2y = -3\)',
       r'\(3\)(\(5 \over 2))\( -y\))\(+ 2y = -3\)',
        r'\(3x + 2(2x - 5) = -3\)',
    ...
    Question(r'If x − y = 3 and x + y = 5, what is the value of y?',
     'D', null,
      r'-4',
       r'-2',
        r'-1',
    ...
    Question(r'If 5x + y = 19 and x − 3y = 7, then x + y =',
     'C', null,
      r'-4',
       r'-1',
        r'3',
    ...
    Question(r'If x − 9 = 2y and x + 3 = 5y, what is the value of x?',
     'D', null,
      r'-2',
       r'4',
        r'11',
    ...
    Question(r'If \(1 \over x\)\(+\)\(1 \over y\)\(=\)\(1 \over 4\) and \(1 \over x\)\(-\)\(1 \over y\)\(=\)\(3 \over 4\), then \(x =\)',
     'C', null,
      r'\(1 \over 4\)',
       r'\(1 \over 2\)',
        r'\(2\)',
    ...
    Question(r'If \(5a + 3b = 35\) and \(a \over b\) \(=\) \(2 \over 5\), what is the value of \(a\)?',
     'A', null,
      r'\(14 \over 5\)',
       r'\(7 \over 2\)',
        r'\(5\)',
    ...
    Question(r'If \(x \over y\)\(= 6\), \(y \over w\)\(= 4\), what is the value of \(w\)?',
     'B', null,
      r'\(1 \over 2\)',
       r'\(3 \over 2\)',
        r'\(2\)',
    ...
    Question(r'If 4r + 7s = 23 and r − 2s = 17 then 3r + 3s =',
     'B', null,
      r'8',
       r'24',
        r'32',
    ...
    Question(r'If \(p - q \over 2\)\(= 3\) and \(rq - rq =12\), then \(r =\)',
     'C', null,
      r'-1',
       r'1',
        r'2',
